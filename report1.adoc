...
reliable transport layer protocols like TCP and Websocket. The draft https://tools.ietf.org/html/draft-ietf-core-coap-tcp-tls-17[https://tools.ietf.org/html/draft-ietf-core-coap-tcp-tls-17]
