...
The test setup consists of an OSGi based server application and a client
application. The applications could be bundled with protocol APIs like
CoAP, MQTT and Websocket. The application protocol API under test is plugged in to the server and the client
