...
| CoAP | All types of Communication possible | Slow without BERT option | Needs to be handled by the application | Libraries available eg : node-coap https://github.com/mcollina/node-coap
| MQTT | Synchronous communication not possible | Fast | Handled by the protocol | Libraries available 
| WebSocket | All types of Communication possible | Fast |  Needs to be handled by the application | Supported by all the major browsers
|====================
